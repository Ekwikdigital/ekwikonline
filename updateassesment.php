...
if(isset($_REQUEST['editassesment'])) 
{
$s_no = $_REQUEST["s_no"];
...
$assesment_code = $_REQUEST["assesment_code"];
}
?>
<!DOCTYPE html>
<html lang="zxx">
<head>
    ...
    <name>Ekwik Online || Best Digital Marketing Institute</name>
                ...
                <div class="form-content">
                    <div class="form-items">
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <input class="form-control" type="text" name="u_assesment_id" id="assesment_id" value=<?php echo $assesment_id?> required placeholder="assesment Id">
                            <input class="form-control" type="text" name="u_assesment_name" id="assesment_name" value=<?php echo $assesment_name?> required placeholder="assesment Name">
                            <input class="form-control" type="text" name="u_assesment_code" id="assesment_code" value=<?php echo $assesment_code?> placeholder="assesment Code">
...
$u_assesment_id = $_POST["u_assesment_id"];
$u_assesment_name = $_POST["u_assesment_name"];
$u_assesment_code = $_POST["u_assesment_code"];

    $sql2 = "UPDATE assesment SET batch_id='$u_batch_id', content_id='$u_content_id', assesment_id='$u_assesment_id', assesment_name='$u_assesment_name', assesment_code='$u_assesment_code' WHERE s_no='$s_no'";
...
if($result2){
    ...
    ?>
    <meta http-equiv="Refresh" content="0; URL=http://localhost/ekwikonline/captaincode.php#assesments">
    <?php 
}
else {
