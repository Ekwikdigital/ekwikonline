...
const digital_marketing = document.getElementById("digital_marketing");
const web_designing = document.getElementById("web_designing");
const web_development = document.getElementById("web_development");
const wordpress_development = document.getElementById("wordpress_development");
const s1 = document.getElementById("sub_c_section1");
const s2 = document.getElementById("sub_c_section2");
const s3 = document.getElementById("sub_c_section3");
const s4 = document.getElementById("sub_c_section4");
console.log(s1);

digital_marketing.addEventListener('click', function() {
    s1.style.display = "block";
    s2.style.display = "none";
    s3.style.display = "none";
    s4.style.display = "none";
});
web_designing.addEventListener('click', function() {
    s1.style.display = "none";
    s2.style.display = "block";
    s3.style.display = "none";
    s4.style.display = "none";
});
web_development.addEventListener('click', function() {
    s1.style.display = "none";
    s2.style.display = "none";
    s3.style.display = "block";
    s4.style.display = "none";
});
wordpress_development.addEventListener('click', function() {
    s1.style.display = "none";
    s2.style.display = "none";
    s3.style.display = "none";
