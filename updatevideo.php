...
$video_code = $_REQUEST["video_code"];
}
?>
<!DOCTYPE html>
<html lang="zxx">
                ...
                <div class="form-content">
                    <div class="form-items">
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <input class="form-control" type="text" name="u_video_id" id="video_id" value=<?php echo $video_id?> required placeholder="Video Id">
                            <input class="form-control" type="text" name="u_video_title" id="video_title" value=<?php echo $video_title?> required placeholder="Video Name">
                            <input class="form-control" type="text" name="u_video_code" id="video_code" value=<?php echo $video_code?> placeholder="Video Code">
...
$u_video_id = $_POST["u_video_id"];
$u_video_title = $_POST["u_video_title"];
$u_video_code = $_POST["u_video_code"];

    $sql2 = "UPDATE videos SET batch_id='$u_batch_id', content_id='$u_content_id', video_id='$u_video_id', video_title='$u_video_title', video_code='$u_video_code' WHERE s_no='$s_no'";
...
if($result2){
    ...
    ?>
    <meta http-equiv="Refresh" content="0; URL=http://localhost/ekwikonline/captaincode.php#videos">
    <?php 
}
else {
