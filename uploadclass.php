...
$existSql = "SELECT * FROM `classes` WHERE class_id='$class_id'";
...
if($numExistRows > 0){
    ...
    $sql2 = "INSERT INTO `classes` (`batch_id`, `content_id`,`class_id`,`class_title`,`class_code`) VALUES ('$batch_id', '$content_id', '$class_id','$class_title','$class_code')";
            ...
            <div class="form-holder">
                <div class="form-content">
                    ...
                    include('./include/db_connect_copy.php');
                        ...
                        $sql_batch = "SELECT * FROM `classes` ORDER BY s_no DESC LIMIT 1";
                        ...
                        if(mysqli_num_rows($result_batch) > 0)
                        {
                            ...
                            {
                                echo "
                                <p> Last class id <span class='red'> ".$row['class_id']." </span> and Title is <span class='red'> ".$row['class_title']." </span>.
                                    ";
                            }
                        }
                        ?>
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <input class="form-control" type="text" name="class_id" id="class_id" placeholder="class Id" required>
                            <input class="form-control" type="text" name="class_title" id="class_title" placeholder="class Title" required>
                            <input class="form-control" type="text" name="class_code" id="class_code" placeholder="class code" required>
