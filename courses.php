            ...
            <div class="first-screen section-screen-main">
                ...
                <div class="wrapper">
                    <div class="screen-main">
                        <div class="section-heading"><span>Our Courses</span></div>
                        <h1 class="h1 h1-main">Here Are Course</h1>
                ...
                <div class="wrapper">
                    <div class="services">
                        ...
                        <div class="services__item">
                            ...
                            <div id="web_development" class="services__title"><abbr title="Every Web Developer must have a basic understanding of HTML, CSS, and JavaScript. Responsive Web Design is used in all types of modern web development."> Social Media Optimization  </abbr></div>
...
Make it a mission now and know what you can learn in digital marketing to spread the wings of knowledge in a world which needs you.</p>
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt, quaerat.</p>
                    <div class="price">
                        <div class="sub-price">
