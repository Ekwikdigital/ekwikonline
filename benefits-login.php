...
$result0 = mysqli_query($conn, $existSql);
$numExistRows = mysqli_num_rows($result0);
if($numExistRows > 0){
    // $exists = true;
    ...
    if(($s_password == $s_c_password)){
        $sql = "INSERT INTO `benefits_users` (`username`, `password`, `email`) VALUES ('$s_username',  '$s_password', '$s_email')";
